...
The project must compile and display the Solution class's annotation.
Don't change the Solution class or its annotation. The Changelog annotation must be visible at runtime.
