...
public class Solution {
    ...
    private static String getWeekOfTheYear(LocalDate localDate) {

        int weekNumber = localDate.getDayOfYear() / 7;

        return String.valueOf(weekNumber);
    }

    private static String getWeekOfTheMonth(LocalDate localDate) {
        int weekNumber = localDate.getDayOfMonth() / 7;
